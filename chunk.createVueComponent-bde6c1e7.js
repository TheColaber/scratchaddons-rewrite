...
var chromePromiseExports = chromePromise$1.exports;
...
var chromep$1 = /*@__PURE__*/getDefaultExportFromCjs(chromePromise);
...
const getStorageArea = (area) => {
    switch (area) {
        case 'local':
            return chromep$1.storage.local;
        case 'sync':
            return chromep$1.storage.sync;
        case 'managed':
            return chromep$1.storage.managed;
        default:
...
const syncStorage = getBucket("syncstorage", "sync");
const localStorage = getBucket("localstorage", "local");
...
const createVueComponent = (iconName, iconNamePascal, iconNode) => (_a, { attrs, slots }) => {
  var _b = _a, { size, color, stroke } = _b, props = __objRest(_b, ["size", "color", "stroke"]);
  return h(
    "svg",
...
export { Fragment as F, Icon as I, Suspense as S, _export_sfc as _, styleInject as a, createElementBlock as b, createVueComponent as c, defineComponent as d, createTextVNode as e, createBaseVNode as f, normalizeStyle as g, createCommentVNode as h, createVNode as i, withAsyncContext as j, renderList as k, localStorage as l, withDirectives as m, normalizeClass as n, openBlock as o, renderSlot as p, createApp as q, ref as r, syncStorage as s, toDisplayString as t, unref as u, vShow as v, withCtx as w, createBlock as x, isRef as y, resolveDynamicComponent as z };
