...
var chromePromiseExports = {};
var chromePromise$1 = {
  get exports(){ return chromePromiseExports; },
  set exports(v){ chromePromiseExports = v; },
};
...
var ChromePromise = chromePromiseExports;

var chromep = new ChromePromise();
// Temporary hacky fix to make TypeScript `import` work
chromep.default = chromep;

var chromePromise = chromep;
...
const getStorageArea = (area) => {
    switch (area) {
        case 'local':
            return chromePromise.storage.local;
        case 'sync':
            return chromePromise.storage.sync;
        case 'managed':
            return chromePromise.storage.managed;
        default:
...
var storage$1 = getBucket("storage", "sync");
...
export { Fragment as F, Icon as I, Suspense as S, styleInject as a, createBaseVNode as b, createElementBlock as c, defineComponent as d, createVNode as e, createTextVNode as f, renderSlot as g, normalizeStyle as h, createCommentVNode as i, withCtx as j, withAsyncContext as k, renderList as l, createApp as m, normalizeClass as n, openBlock as o, createBlock as p, isRef as q, ref as r, storage$1 as s, toDisplayString as t, unref as u, vShow as v, withDirectives as w, resolveDynamicComponent as x };
